# Contributing to Stroop Contracts
...
Requires a recent stable Rust toolchain and the Stellar CLI for deployment
work. Contract deployment takes signing keys from environment variables or a
secure signer — never from a file in this repository.
...
Authorization changes require negative tests: prove the unauthorized caller is
